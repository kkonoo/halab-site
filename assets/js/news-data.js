...
window.NEWS = [
  ...
  },
  {
    ...
    bodyKo: [
      "한 달이 정말 빠르게 지나갔습니다! <b>네 명의 인턴(윤서, 재훈, 호준, 소윤)</b>과 함께한 짧은 여름이 즐겁고 의미 있는 경험이었기를 바랍니다 ☀️",
      "우리와 여름을 함께해 줘서 고마워요. 언제든 편하게 놀러 오세요 :)"
    ]
  },
  {
    date: "Jul 2026",
    ...
    bodyKo: [
      "7월에 합류한 <b>네 명의 여름 인턴(윤서, 재훈, 호준, 소윤)</b>과 환영 점심을 함께하며 여름을 시작했습니다 🍽️",
      "한 달이라는 짧은 시간이지만 마음껏 참여하고 질문하며 알차게 보내길 바랍니다. 함께 즐거운 시간 보내요! 🤗"
    ]
  },
  {
    date: "May 2026",
    ...
    bodyKo: [
      "우리 연구실이 <b>바이오·의료기술개발사업(NRF)</b> 신규 과제에 선정되었으며, 은지 교수가 <b>공동연구원</b>으로 참여합니다.",
      "<b>\"근감소증 개선을 위한 미세아교세포 표적 항노화 유전자 전달 효능 연구\"</b>에서 뇌–말초 운동 회로를 따라 SIRT3 기반 유전자 치료 후보를 연구하며, 우리 연구실은 멀티오믹스 분석을 담당합니다."
    ]
  },
  {
    date: "Apr 2026",
    ...
    body: [
      ...
      "Wishing you all the best in whatever comes next — and remember, you're always welcome back :)"
    ],
    bodyKo: [
      "두 달이 눈 깜짝할 사이에 지나갔습니다! <b>기윤, 서회, 승재</b> 학생의 노력과 호기심에 고마움을 전합니다. 짧았지만 함께해 즐거웠어요 🤗",
      "앞으로의 모든 여정을 응원합니다. 언제든 다시 찾아오세요 :)"
    ]
  },
  {
    date: "Mar 2026",
    ...
    body: [
      ...
      "We look forward to the exciting discoveries this support will enable."
    ],
    bodyKo: [
      "우리 연구실이 <b>한국연구재단(NRF) 우수신진연구사업</b>에 선정되었습니다 🥳",
      "향후 5년간 <b>\"AI 기반 선조체 입력 회로 멀티오믹스 분석\"</b> 연구를 수행합니다.",
      "이번 지원을 통해 이어질 흥미로운 발견을 기대합니다."
    ]
  },
  {
    date: "Jan 2026",
    ...
    body: [
      ...
      "We started the year with 뭉티기 (Daegu-style raw beef) and Korean fried chicken. And a special welcome to the <b>two new students (명훈, 규진)</b> joining our young lab. Looking forward to seeing you grow and succeed here:) I am here to support your journey🪄",
      "Let’s make it a great year✨"
    ],
    bodyKo: [
      "맛있는 음식과 더 좋은 사람들!",
      "대구식 생고기 뭉티기와 치킨으로 새해를 시작했습니다. 젊은 연구실에 새로 합류한 <b>두 학생(명훈, 규진)</b>도 진심으로 환영합니다. 이곳에서 성장하고 좋은 결실을 맺도록 늘 응원할게요 🪄",
      "멋진 한 해를 함께 만들어 봅시다 ✨"
    ]
  },
  {
    ...
    bodyKo: [
      "경북대학교 의과대학 분자의학교실에 <b>유전체의학 연구실</b>을 열게 되어 기쁩니다.",
      "은지 교수가 이끄는 우리 연구실은 통합 멀티오믹스와 계산 방법을 통해 복합 질환의 유전적·후성유전적 기전을 연구합니다.",
      "경북대학교에서 시작하는 첫걸음입니다. 대학원생, 동료, 국제 공동연구자와 활기차고 협력적인 연구 환경을 만들어 가겠습니다.",
      "연구 프로젝트, 논문, 연구실 합류 기회에 관한 새로운 소식을 기대해 주세요 ✨"
    ]
  }
];
